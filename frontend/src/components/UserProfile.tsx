...
import { Github, Linkedin, Mail, Phone, MapPin, Calendar, Briefcase, Link as LinkIcon, Eye, EyeOff, X, Plus, CalendarIcon } from 'lucide-react'
            ...
            <div className="flex flex-row justify-center items-center min-h-screen bg-white text-gray-900 p-6 m-auto">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="col-span-1 shadow-lg border border-gray-200 rounded-lg">
