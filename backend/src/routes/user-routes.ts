...
import { handleUserLogin, handleUserLogout, handleUserProfile, handleUserSignup, handleVerifyUserEmail, handleParticipateInProject, verifyUserFromToken, handleShowProjectDetails, handleReviewCollabProposal } from '../controllers/user-controllers';
...
userRoute
    ...
    .get("user/collab-proposal/:projectId/:recipientId/:reviewCode", onlyLoggedInUsers, handleReviewCollabProposal);
